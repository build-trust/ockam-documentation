...
Now that you understand how Ockam empowers you to add strong security controls and guarantees to any application, [read more](./#use-cases) about how developers are using Ockam for many [use cases across industries](./#use-cases) or start building by diving into our tools and libraries:&#x20;
