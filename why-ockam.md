...
With Ockam, applications can, in a few lines of code, create mutually authenticated [secure channels](command-line-users/secure-channels.md) that guarantee end-to-end data integrity to senders and receivers of data.
