...
Ockam Routing is an application layer routing protocol that provides the ability to route messages between [workers](broken-reference) within a [node](nodes.md) or across nodes using [transports](transports/).
